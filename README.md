...
サイクル名の「5年」「7年」「10年」「15年」は、厳密な所有年数ではなく、対象車齢の車検前に買い替える運用名です。実装上は車検前に切り替えるため、買替間隔はサイクル年数より1〜2年短くなります。このため、短期サイクルでは車検回数と高額イベントが少なくなる一方、買替回数とローン期間は増えます。表示上の年数はサイクル名であり、実買替年は車検前に前倒しされます。

`現車を最後まで維持・最終売却` は、評価期間中に買替を行わず、最後に売却して車利用を終了するシナリオです。47歳から約25年の車利用期間全体を見るうえで、買替なしの上限ケースとして使います。`現車を20年維持・最後に1回買替` は20年目ちょうどではなく、20年目車検前相当へ前倒しして買替を発生させる別シナリオです。
