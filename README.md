...
年合計にはローン、維持費、修理期待値、車検、高額イベント費用を含めます。下取り額や最終車両価値は支出から控除せず、車両価値と純資産として別に表示します。
...
年次キャッシュフローでは「ローンだけの月額」と、維持費・修理・車検・高額イベントを含む「その年の必要月額」を別指標として見ます。買替年のローン年額には初回頭金を含め、ローン最終年には最終月額と残価を含めます。
...
画面の「前提・単価・計算ルール」では、開始年、ローン条件、維持費、修理期待値、高額イベント、資産価値、年合計と月額の式を確認できます。商談中に、どの金額が年合計に入り、どの金額が資産価値や最終売却額として別表示されるのかを画面だけで確認するための補助です。
