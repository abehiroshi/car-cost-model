...
画面の「前提・単価・計算ルール」では、開始年、ローン条件、維持費、修理期待値、高額イベント、資産価値、年合計と月額の式を確認できます。商談中に、どの金額が年合計に入り、どの金額が資産価値や最終売却額として別表示されるのかを画面だけで確認するための補助です。新車購入費用と下取り想定額は支出合計とは別に表示し、ローン支払いだけを家計支出として年合計に入れます。
